...
<head>
    ...
    <title>Dashboard Infirmier - Centre Hospitalier</title>
                    ...
                    <div class="relative">
                        <button onclick="toggleDropdown()" class="flex items-center space-x-3 bg-gradient-to-r from-blue-900 to-blue-700 px-4 py-2 rounded-lg shadow cursor-pointer hover:shadow-md transition">
                            ...
                            <div class="text-white">
                                <p class="font-semibold text-sm">Marie Dupont</p>
                                <p class="text-xs text-blue-200">Infirmier</p>
                            </div>
        ...
        <aside class="w-64 sidebar-gradient text-white min-h-screen">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('infirmier.patients') }}" class="flex items-center space-x-3 px-4 py-3 hover:bg-white/10 rounded-lg transition">
